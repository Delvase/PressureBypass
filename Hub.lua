...
-- ==================== AUTO FARM (из autofarm_mm2, логика без изменений) ====================
...
FarmTab:Dropdown({
    ...
    Callback = function(opt)
        local name = type(opt) == "table" and (opt.Title or opt[1] or opt) or opt
        FarmSettings.CoinLimit = tonumber(name) or 40
    end,
})
