...
local espSettings = {
    ...
    Outline = { Enabled = false, Everyone = false, Murderer = true, Sheriff = true, Innocent = true, Gun = true },
    ...
    Box = { Enabled = false, Everyone = false, Murderer = true, Sheriff = true, Innocent = true, Gun = true },
}
...
task.spawn(function()
    while task.wait(2) do
        if ESPMaster then refreshRoles() end
    end
end)
...
EspTab:Toggle({
    Title = "Boxes",
    Value = false,
    Callback = function(v) espSettings.Box.Enabled = v end,
})
...
EspTab:Toggle({
    Title = "Outline",
    Value = false,
    Callback = function(v) espSettings.Outline.Enabled = v end,
})
...
EspTab:Toggle({
    ...
    Callback = function(v)
        ...
        espSettings.Box.Gun = v
        espSettings.Chams.Gun = v
        espSettings.Outline.Gun = v
...
EspTab:Toggle({
    ...
    Callback = function(v)
        ...
        espSettings.Box.Murderer = v
        espSettings.Chams.Murderer = v
        espSettings.Outline.Murderer = v
...
EspTab:Toggle({
    ...
    Callback = function(v)
        ...
        espSettings.Box.Sheriff = v
        espSettings.Chams.Sheriff = v
        espSettings.Outline.Sheriff = v
...
EspTab:Toggle({
    ...
    Callback = function(v)
        ...
        espSettings.Box.Innocent = v
        espSettings.Chams.Innocent = v
        espSettings.Outline.Innocent = v
...
EspTab:Toggle({
    ...
    Callback = function(v)
        ...
        espSettings.Box.Everyone = v
        espSettings.Chams.Everyone = v
        espSettings.Outline.Everyone = v
...
SkyTab:Dropdown({
    ...
    Callback = function(opt)
        ...
        CurrentSkybox = name
        -- всегда применяем при выборе, если включено; если выключено — включаем и ставим
        SkyboxEnabled = true
        Skybox_Apply(CurrentSkybox)
    end,
})
...
ShaderTab:Dropdown({
    Title = "Time Shader",
    Values = {"Morning", "Midday", "Afternoon", "Evening", "Night", "Midnight"},
    Value = "Midday",
    Callback = function(opt)
        local name = type(opt) == "table" and (opt.Title or opt[1] or opt) or opt
...
ShaderTab:Dropdown({
    ...
    Values = {"Sunny", "Rain", "Snow", "Fog", "Storm"},
    Value = "Sunny",
    Callback = function(opt)
        local name = type(opt) == "table" and (opt.Title or opt[1] or opt) or opt
        if ShaderPresets[name] then
...
ShaderTab:Dropdown({
    Title = "Color Shader",
    Values = {"Red", "Blue", "Green", "Purple", "Pink"},
    Value = "Blue",
    Callback = function(opt)
        local name = type(opt) == "table" and (opt.Title or opt[1] or opt) or opt
        if ShaderPresets[name] then
